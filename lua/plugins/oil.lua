...
return {
	{
		...
		opts = {
			...
			keymaps = {
				...
				["<C-.>"] = { "actions.toggle_hidden", mode = "n", desc = "Show hidden files" },
				["g\\"] = { "actions.toggle_trash", mode = "n" },
				["<esc>"] = { smart_quit, desc = "Close Oil File Explorer" },
				["q"] = { smart_quit, desc = "Close Oil File Explorer" },
				["<leader>e"] = { smart_quit, desc = "Close Oil File Explorer" },
			},
		},
